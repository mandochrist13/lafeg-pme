...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  if (!isAuthenticated && pathname === "/admin/login") return <>{children}</>;
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center px-3 py-2 text-sm font-medium rounded-md ${
                      isActive ? "bg-white text-[#063a1e]" : "text-white hover:bg-[#063a1e]/50"
                    }`}
                  >
          ...
          <div className="flex flex-col h-full">
            <div className="flex bg-white items-center justify-between p-4">
              <div className="flex gap-4 items-center">
                ...
                <div className="ml-3">
                  <h1 className="text-lg font-bold text-[#063a1e]">ADMIN</h1>
                  <p className="text-xs text-[#063a1e]">Guide Numérique des PME</p>
                </div>
              </div>
            </div>
